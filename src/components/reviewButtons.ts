...
export function createReviewModal() {
	...
	const secondRow = new ActionRowBuilder<TextInputBuilder>().addComponents(reviewInput);

	modal.addComponents(firstRow, secondRow);
	return modal;
}

export async function handleUsefulButton(interaction: ButtonInteraction, guild: GuildData) {
